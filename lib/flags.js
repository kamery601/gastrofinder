...
const DEFINITIONS = {
  ...
  // Shadow read: catalog is queried and COMPARED against live results in the
  // background - never shown to the user. The evidence source for Fala 2.
  ...
  // First-party, time-bounded corrections for locally verified seasonal
  // closures. Independent of Catalog Core and safe to roll back instantly.
  SEASONALITY_OVERRIDES_ENABLED: false,
